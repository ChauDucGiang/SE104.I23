...
namespace QLHS
{
    public partial class frmLop : Form
    {
        ...
        void loadKLintoCombobox()
        {
            ...
            cmbKhoilop.DisplayMember = "TenKhoi";
        }
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            string khoiLop = (cmbKhoilop.SelectedItem as KhoiLop).MaKhoi;
        ...
        private void btnTimkiem_Click(object sender, EventArgs e)
        {
            ...
            if (radTimtheotenlop.Checked)
            {
                ...
                {
                    dGVLop.DataSource = DataProvider.Instance.ExecuteQuery("SELECT MaLop, TenLop, NamHoc, MaKhoiLop FROM Lop WHERE TenLop=" + inputData);
                }
                else {
                    MessageBox.Show("Lớp không tồn tại !","Thông báo");
                }
