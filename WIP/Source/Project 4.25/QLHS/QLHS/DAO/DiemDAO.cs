...
namespace QLHS.DAO
{
    public class DiemDAO
    {
        ...
        public void LuuDiem(int mahs, string malop, string macotdiem, float diemso, int hocki, string namhoc, string mamon)
        {
        ...
        public bool KiemTraMaHSInBangDiem(int mahs)
        {
        ...
        public DataTable LoadSTInClassByMaLopAndNamHoAndMaMH(string malop, string namhoc, string mamh)
        {
            string query = "EXEC dbo.USP_GetBangDiem @malop = '" + malop + "',@manamhoc = N'" + namhoc + "',@mamon = '" + mamh + "'";
