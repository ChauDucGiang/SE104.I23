        ...
        private void btbOK_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (cmbAuthentication.SelectedIndex == 0)
                {
                    ...
                    EditAppSetting("connection", "XpoProvider=MSSqlServer;data source=" + cmbServerName.SelectedItem.ToString() + ";integrated security=SSPI;initial catalog=" + cmbDatabase.SelectedItem.ToString());
                    EditAppSetting("QLHS.Properties.Settings.ConnectionSTR", "Data Source=" + cmbServerName.SelectedItem.ToString() + ";Initial Catalog=" + cmbDatabase.SelectedItem.ToString() + ";Integrated Security=True;");
                    EditAppSetting("localhost_QuanLyHocSinh_Connection", "Data Source=" + cmbServerName.SelectedItem.ToString() + ";Initial Catalog=" + cmbDatabase.SelectedItem.ToString() + ";Integrated Security=True;");
                    EditAppSetting("localhost_QuanLyHocSinh_Connection 1", "Data Source=" + cmbServerName.SelectedItem.ToString() + ";Initial Catalog=" + cmbDatabase.SelectedItem.ToString() + ";Integrated Security=True;");
                }
                else
