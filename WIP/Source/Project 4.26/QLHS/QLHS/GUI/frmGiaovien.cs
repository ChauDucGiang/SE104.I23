    ...
    public partial class frmGiaovien : Form
    {
        ...
        private void btnTimkiem_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    bd.DataSource = SearchGVByMaGV(txtNhapthongtincantimkiem.Text);
                }
                else if (radTimtheotengiaovien.Checked)
                {
                    bd.DataSource = SearchGVByTenGV(txtNhapthongtincantimkiem.Text);
                }
            }
        }
        ...
        {
            string magv = CheckType.chuanHoa(txtMagiaovien.Text).ToUpper();
            string tengv = CheckType.chuanHoa(txtTengiaovien.Text);
            ...
            if (magv != null && tengv != null && sdt != null && diachi != null && mamh != null)
            {
                ...
                else MessageBox.Show("Mã giáo viên đã tồn tại rồi !!!", "Thông báo");
            }
        ...
        {
            string magv = dGVGiaovien.CurrentRow.Cells["colMagiaovien"].Value.ToString();
            string tengv = dGVGiaovien.CurrentRow.Cells["colTengiaovien"].Value.ToString();
