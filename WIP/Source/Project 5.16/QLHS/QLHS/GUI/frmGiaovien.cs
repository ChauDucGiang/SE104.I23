...
namespace QLHS
{
    public partial class frmGiaovien : Form
    {
        ...
        public frmGiaovien()
        {
            ...
            txbDiaChi.AutoCompleteMode = AutoCompleteMode.Suggest;
            txbDiaChi.AutoCompleteSource = AutoCompleteSource.CustomSource;
        }
        #region Event
        private void txbDiaChi_TextChanged(object sender, EventArgs e)
        {
           // CheckType.GooglePlace(txbDiaChi);
        }
        ...
        private void btnTimkiem_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (radTimtheomagiaovien.Checked)
                {
                    ...
                    //if (GiaoVienDAO.Instance.CheckGiaoVienExist(txtNhapthongtincantimkiem.Text))
                    //    bd.DataSource = SearchGVByMaGV(CheckType.chuanHoaMa(txtNhapthongtincantimkiem.Text));
                    //else
                    //{
